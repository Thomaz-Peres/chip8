...
unsafe
{
    ...
    Sdl.SDL_Texture texture = *Sdl.SDL_CreateTexture(renderer, Sdl.SDL_PixelFormat.SDL_PIXELFORMAT_RGBA8888, Sdl.SDL_TextureAccess.SDL_TEXTUREACCESS_TARGET, 640, 480);
    ...
    while (true)
    {
        ...
        {
            Sdl.SDL_RenderPoint(renderer, item, item);
        }
        // int x = 640;
        // for (int i = 0; i < 640; i++)
        // {
